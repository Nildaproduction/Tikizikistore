...
"[project]/app/store/checkout/checkout-content.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        "CheckoutContent.useEffect": ()=>{
            if (items.length > 0) {
                const snapshot = items.map({
                    "CheckoutContent.useEffect.snapshot": (item)=>({
                            productId: item.product.id,
                            quantity: item.quantity,
                            selectedSize: item.selectedSize,
                            selectedColor: item.selectedColor
                        })
                }["CheckoutContent.useEffect.snapshot"]);
...
_s(CheckoutContent, "vcQp0jvv9+w1LGox+aJI9A114xM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$cart$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"],
...
//# sourceMappingURL=_7da55a7c._.js.map