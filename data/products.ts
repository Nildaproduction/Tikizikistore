...
export const products: Product[] = [
 
  {
    ...
    description: "Premium Gold Man beanie in walnut colour.",
    price: 1500,
    category: 'Merch',
    type: 'physical',
  ...
  },
  {
    id: '5',
    name: 'Gold Man - Black',
    description: "Premium Gold Man beanie in black colour",
    price: 1500,
    category: 'Merch',
    type: 'physical',
  ...
  },
  {
    id: '13',
    name: 'Gold Man - Red',
    description: "Premium Gold Man beanie in red colour",
    price: 1500,
    category: 'Merch',
    type: 'physical',
  ...
  {
    id: '5',
    name: 'Gold Man - Cypress',
    description: "Premium Gold Man beanie in Cypress colour",
    price: 1500,
    category: 'Merch',
    type: 'physical',
  ...
  },
  {
    id: '14',
    name: 'Gold Man -  Ecru',
    description: "Premium Gold Man beanie in Ecru colour",
    price: 1500,
    category: 'Merch',
    type: 'physical',
